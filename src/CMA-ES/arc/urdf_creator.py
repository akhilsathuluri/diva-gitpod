...
def dv_sampled2dv_urdf(dv):
    ...
    return [dv[0], dv[1]*dv[2], dv[1]*(1-dv[2]), dv[3]*dv[4], dv[3]*(1-dv[4])]+ [1050, 0.055, 0.055] +dv[5:]
...
def urdf_creator(sampled_dv, path = 'None'):
    ...
    if path == 'None':
        # urdf_path = '~/git/research/xray/src/problems/DIVAR3V/library/urdfs'+robot_name+'.urdf'
