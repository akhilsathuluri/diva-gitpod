...
def urdf_creator(sampled_dv, fit_params, path = 'None'):
    ...
    # Lets start with same stiffness for all links
    ...
    m = np.insert(m, 5, calc_mass(dv['rho'], dv['sh'], dv['a6']))
    print(m)
